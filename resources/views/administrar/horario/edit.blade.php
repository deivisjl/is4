      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                  <form action="{{ url('horarios', [$horario->id]) }}" method="POST" autocomplete="off">
                            <input name="_method" type="hidden" value="PUT">
                      @csrf
                      <div class="form-group">
                          <label for="">Nombre</label>
                          <input type="text" class="form-control {{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" value="{{ $horario->nombre }}">
