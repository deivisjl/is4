            ...
            <div class="col-md-8 offset-md-2">
                <div class="card card-default">
                  <div class="card-header-custom">
                      <h5 class="float-left">Grados</h5>
                      <a href="{{ route('grados.create') }}" class="btn btn-primary float-right btn-sm">Nuevo registro</a>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
...
<script>
    ...
    var obtener_data_editar = function(tbody,table){
         $(tbody).on("click","a.editar",function(e){
          ...
          var id = data.id;
           window.location.href = "/grados/" + id + "/edit";
        });
